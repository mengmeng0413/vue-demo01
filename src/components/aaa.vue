<template>
		<div>
			<el-carousel :interval="4000" type="card">
				<el-carousel-item v-for="item in pics" :key="item" :style="{'background-image': 'url('+item+')','background-size':'264px 400px'}">
				</el-carousel-item>
			</el-carousel>
      ...
      <div style="margin:10px;border:1px #000 solid;padding:10px;">
          ...
          <br>
          A{{msg}}
          <listeners v-on:dblclick.native="onDblclick" 
                    :msg="msg"
...
<script>
  ...
  import cropper from './widget/cropper'
	export default {
		data () {
				return {
          pics:[require('../assets/111.jpeg'),require('../assets/222.jpg'),require('../assets/333.jpg')],
          testModel: true,
          test_data:'',
          username:'',
          inputvalue:'',
